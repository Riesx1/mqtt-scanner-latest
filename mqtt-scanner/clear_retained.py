...
def clear_broker(host, port, use_tls=False, username=None, password=None):
    ...
    client_id = f"cleaner-{port}"

    # Handle paho-mqtt v2.x vs v1.x compatibility
...
if __name__ == "__main__":
    ...
    clear_broker("127.0.0.1", 8883, use_tls=True, username="faris@gmail.com", password="faris123")
