...
const char *mqtt_user = "faris@gmail.com";
...
// MQTT TOPICS
// ============================================================================
const char *topic_dht_secure = "sensors/faris/dht_secure";     // Secure DHT
const char *topic_ldr_secure = "sensors/faris/ldr_secure";     // Secure LDR
const char *topic_pir_insecure = "sensors/faris/pir_insecure"; // Insecure PIR
...
void printMqttError(const char *connectionType, int rc)
{
  ...
  case -3:
    ...
    break;
  case -2:
    Serial.println("MQTT_CONNECT_FAILED (Network/TLS)");
    break;
  case -1:
